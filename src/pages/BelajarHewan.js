    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-blue-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Belajar Mengenal Hewan 🐾</h1>
          <p className="text-xl mb-8">Mari mengenal berbagai jenis hewan dan kehidupannya!</p>
      ...
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-2xl font-bold mb-4 text-purple-600">Kategori Hewan</h2>
