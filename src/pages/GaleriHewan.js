...
const GaleriHewan = () => {
  ...
  const species = [
    ...
    },
    {
      id: 7,
      name: 'Sapi',
      image: 'https://awsimages.detik.net.id/community/media/visual/2021/07/19/sapi-limosin.jpeg?w=600&q=90',
      description: 'Sapi adalah mamalia besar yang sering dibudidayakan untuk daging, susu, dan kulitnya.',
      sound: '/audio/sapi.mp3',
      speed: '40 km/jam',
    ...
    },    
    {
      id: 8,
      name: 'Ayam',
      image: 'https://awsimages.detik.net.id/community/media/visual/2022/02/04/ayam-betina.jpeg?w=600&q=90',
      description: 'Ayam adalah mamalia yang sering dipelihara untuk daging dan telurnya, ditemukan di hampir seluruh dunia.',
      sound: '/audio/ayam.mp3',
      speed: '15 km/jam',
      lifespan: '5 - 10 tahun',
      weight: '2 - 5 kg',
      origin: 'Seluruh Dunia',
